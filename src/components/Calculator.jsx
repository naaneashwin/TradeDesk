    ...
    <div style={{ maxWidth: 640 }}>
      <div style={CARD}>
        ...
        >
          ...
          <Field
            ...
            hint={isLong ? "Must be below entry (long)" : "Must be above entry (short)"}
            form={form}
            onChange={onChange}
          />
        </div>
      ...
      {result && (
        <>
          <div
            style={{
              background: isLong ? "var(--green-light)" : "rgba(220,38,38,0.07)",
  ...
  const CompareCol = ({ label, valid, net, upperBE, lowerBE, beRange, total, isWinner }) => (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
        ...
        {isWinner && (
          <span style={{ fontSize: 11, fontWeight: 700, color: "var(--green)", background: "rgba(45,122,95,0.15)", border: "1px solid rgba(45,122,95,0.25)", borderRadius: 6, padding: "3px 8px" }}>
            ✓ Recommended
          </span>
        )}
      </div>
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 24, maxWidth: 300 }}>
        {["long", "short"].map((d) => {
          ...
          const active = type === d;
          return (
            <button key={d} onClick={() => setType(d)} style={{
            ...
            }}>{d === "long" ? "↑ Long (Buy)" : "↓ Short (Sell)"}</button>
          );
        })}
      </div>
      ...
      <div style={{ display: "flex", gap: 16, marginBottom: 24, maxWidth: 400 }}>
        <div style={{ flex: 1 }}>
          <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>Lots</label>
          <input type="number" className="t-inp font-mono" value={lots} onChange={(e) => setLots(e.target.value)} placeholder="1" />
        </div>
        <div style={{ flex: 1 }}>
          <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>Lot Size</label>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }}>
        {inputCard(
          ...
          <>
            <div style={{ gridColumn: "1 / -1" }}>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>ATM Strike (₹)</label>
              <input type="number" className="t-inp font-mono" value={sad.strike} onChange={(e) => onSad("strike", e.target.value)} placeholder="500" />
            </div>
            <div>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>Call Premium (₹)</label>
              <input type="number" className="t-inp font-mono" value={sad.callP} onChange={(e) => onSad("callP", e.target.value)} placeholder="15" />
            </div>
            <div>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>Put Premium (₹)</label>
        ...
        {inputCard(
          ...
          <>
            <div>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>Call Strike (₹)</label>
            ...
            <div>
              <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 }}>Put Strike (₹)</label>
            ...
            {invalidStrikes && (
              <div style={{ ...ERROR_BOX, gridColumn: "1 / -1" }}>✗ Call strike must be higher than put strike.</div>
            )}
          </>
        )}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }}>
        <CompareCol
          ...
          valid={sadValid} net={sadNet} upperBE={sadUpperBE} lowerBE={sadLowerBE}
          beRange={sadBERange} total={sadTotal}
          isWinner={bothValid && recommendation?.winner === "straddle"}
        />
        <CompareCol
          label={type === "long" ? "Long Strangle" : "Short Strangle"}
          valid={sngValid} net={sngNet} upperBE={sngUpperBE} lowerBE={sngLowerBE}
          beRange={sngBERange} total={sngTotal}
      ...
      {recommendation && (
        <div style={{
          background: "var(--green-light)", border: "1px solid rgba(45,122,95,0.25)",
          borderRadius: 12, padding: 20,
        }}>
          ...
          <p style={{ fontSize: 14, color: "var(--text)", margin: 0, lineHeight: 1.65 }}>
            <strong style={{ color: "var(--green)" }}>
              {recommendation.winner === "straddle"
                ? (type === "long" ? "Long Straddle" : "Short Straddle")
                : (type === "long" ? "Long Strangle" : "Short Strangle")}
            </strong>
            {" — "}{recommendation.text}
          </p>
        </div>
  ...
  return (
    <div style={{ position: "sticky", top: 24, display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 12, padding: 20 }}>
        ...
        {meta.direction === "selectable" ? (
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "9px 16px", borderRadius: 8, background: dirStyle.bg, border: `1px solid ${dirStyle.border}` }}>
            ...
            {meta.outlook && (
              <span style={{ fontSize: 12, color: dirStyle.text, opacity: 0.75 }}>· {meta.outlook}</span>
            )}
          </div>
        )}
      </div>
      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 12, padding: 20 }}>
        ...
        <p style={{ fontSize: 13, color: "var(--text)", lineHeight: 1.65, margin: "0 0 18px" }}>
          {meta.summary}
        </p>
        ...
        <p style={{ fontSize: 12, color: "var(--text-2)", lineHeight: 1.65, margin: "0 0 18px" }}>
          {meta.howItWorks}
        </p>
        ...
        <pre style={{ fontSize: 11, color: "var(--green)", background: "var(--surface-2)", border: "1px solid var(--border)", borderRadius: 8, padding: "10px 12px", margin: 0, fontFamily: "JetBrains Mono, monospace", whiteSpace: "pre-wrap", lineHeight: 1.7 }}>
          {meta.formula}
        </pre>
      </div>
      ...
      {/* Field glossary */}
      <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 12, padding: 20 }}>
        <p style={{ fontSize: 10, fontWeight: 700, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 14 }}>
          Field Reference
        </p>
